    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('accessibility', 'Acessibilidade'), ('comfort', 'Conforto'), ('safety', 'Segurança'), ('technology', 'Tecnologia'), ('commercial', 'Comercial'), ('other', 'Outros')], default='other', help_text='Categoria da facilidade', max_length=50, verbose_name='Categoria')),
            ],
            options={
